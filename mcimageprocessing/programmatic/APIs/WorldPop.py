...
class WorldPop:
    ...
    def process_age_and_sex_structures(self, geometry: Any, worldpop_params: Dict[str, Any]) -> Any:
        """
        :param geometry: The geometry of the region for which age and sex structures are to be processed.
        :param worldpop_params: Parameters for processing age and sex structures, including start date, end date, image collection, and aggregation method.
        :return: If statistics_only parameter is set to True, returns a dictionary with statistics for each age and sex band. Otherwise, returns None.
